...
def get_parser():
    ...
    parser.add_argument('--sheaf_use_deg', dest='sheaf_use_deg', type=str2bool, default=False)
    parser.add_argument('--use_kl', dest='use_kl', type=str2bool, default=False)
    ...
    parser.add_argument('--model', type=str,
                        choices=['DiagSheaf', 'BundleSheaf', 'GeneralSheaf',
                                 'BayesDiagSheaf', 'BayesBundleSheaf', 'BayesGeneralSheaf', 'GCN'],
                        default=None)
    parser.add_argument('--entity', type=str, default=None)
    parser.add_argument('--evectors', type=int, default=0, help="Number of Laplacian PE eigenvectors to use.")
    parser.add_argument('--permute_masks', dest='permute_masks', type=str2bool, default=False,
                        help="Uses val mask for training, test mask fo validation, and train mask for testing")
